...
=======
	private JPanel initActionsPanel() {
		...
		//apercus
		JButton button2 = new JButton("Aper√ßu");
...
>>>>>>> origin/master
			delete.addMouseListener(new MouseListener() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if (retour == JOptionPane.OK_OPTION) {
						...
						if (deleteStatut) {
							JOptionPane.showMessageDialog(fenetre, "Votre image a bien √©t√© supprim√©e.", "Information", JOptionPane.INFORMATION_MESSAGE);
							formesCheckBoxes.remove(image.getName());
							refreshFormesPanel();
							refreshSelectedFormesPanel();
						} else {
							JOptionPane.showMessageDialog(fenetre, "L'image n'a pas pu √™tre supprim√©e.", "Erreur", JOptionPane.ERROR_MESSAGE);
						}
					}	
				}
			});
	...
	private void openFileChooser() {
		...
		if(returnVal == JFileChooser.APPROVE_OPTION) {
			...
			if (saveStatut) {
<<<<<<< HEAD
				JOptionPane.showMessageDialog(fenetre, "Votre image a bien ÈtÈ enregistrÈe.", "Information", JOptionPane.INFORMATION_MESSAGE);
				refreshFormesPanel();
			} else {
				JOptionPane.showMessageDialog(fenetre, "L'image n'a pas pu Ítre enregistrÈe.", "Erreur", JOptionPane.ERROR_MESSAGE);
=======
				JOptionPane.showMessageDialog(fenetre, "Votre image a bien ÔøΩtÔøΩ enregistrÔøΩe.", "Information", JOptionPane.INFORMATION_MESSAGE);
				refreshFormesPanel();
			} else {
				JOptionPane.showMessageDialog(fenetre, "L'image n'a pas pu ÔøΩtre enregistrÔøΩe.", "Erreur", JOptionPane.ERROR_MESSAGE);
>>>>>>> origin/master
			}
		}
	}
